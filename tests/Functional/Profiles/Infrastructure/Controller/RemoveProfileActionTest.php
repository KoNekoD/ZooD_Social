...
class RemoveProfileActionTest extends WebTestCase
{
     ...
     * @throws Exception
     */
    public function test_profile_removed_successfully(): void
    {
        ...
        // act
        $client->request('DELETE', '/api/profiles/'.$profile->getId());
