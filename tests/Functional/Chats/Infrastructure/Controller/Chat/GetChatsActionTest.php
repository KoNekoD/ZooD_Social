...
class GetChatsActionTest extends WebTestCase
{
    use FakerTools;
     ...
     * @throws Exception
     */
    public function test_chat_list_returned_successfully(): void
    {
        ...
        // Getting chats
        $client->request('GET', '/api/chats', ['profileId' => $profile->getId()]);
        $data = json_decode($client->getResponse()->getContent(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
        $this->assertEquals($chat->getId(), $data[0]['id']);
    }
}
